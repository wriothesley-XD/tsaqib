...
@php
    ...
    // Sumber tunggal dari config — duplikat manual dulu bikin data seret.
    // Open space (Alun-Alun Tsaqib) bukan pilihan minat — tidak ikut carousel.
    $daftarKomunitas = array_values(array_filter(
        config('komunitas.daftar', []),
