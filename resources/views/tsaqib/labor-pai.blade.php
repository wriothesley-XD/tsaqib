...
<body class="text-[var(--cream)] font-sans antialiased min-h-screen flex flex-col">
    ...
    <div id="doc-video-modal" class="fixed inset-0 z-50 hidden bg-black/90 backdrop-blur-sm flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-label="Pemutar video dokumentasi">
        <button type="button" data-video-close class="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white text-lg cursor-pointer transition" aria-label="Tutup video">
        ...
        <div class="w-full max-w-3xl space-y-3">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-2">
                ...
                <a id="doc-video-fallback" href="#" target="_blank" rel="noopener"
                   class="text-[11px] font-bold text-[var(--gold)] hover:underline shrink-0">
                    Video tidak dapat dimuat, buka di Google Drive <i class="fa-solid fa-arrow-up-right-from-square text-[9px]"></i>
                </a>
            </div>
        </div>
    </div>
    ...
    // Modal video kunjungan & studi tiru (embed Google Drive)
    (function () {
        ...
        document.querySelectorAll('[data-video-card]').forEach(function (btn) {
